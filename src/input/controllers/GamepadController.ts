...
export class GamepadManager {
    ...
    private readonly moveShape: IStickShapeConfig = { innerDeadzone: 0.14, outerDeadzone: 0.98, exponent: 1.4 };
    private readonly lookShape: IStickShapeConfig = { innerDeadzone: 0.2, outerDeadzone: 0.98, exponent: 2.4 };
    ...
    public poll(_delta: number): void {
        ...
        const moveStick = shapeStickRadial(gp.axes[0] || 0, gp.axes[1] || 0, this.moveShape);
        const lookStick = shapeStickRadial(gp.axes[2] || 0, gp.axes[3] || 0, this.lookShape);
