import { HumanoidJointName, IHumanoidState } from '../contracts/IHumanoid';
import { IPose, IVector3, IQuaternion } from '../contracts/IMath';
import { Vec3Arr, QuatArr } from '../contracts/IEntityState';
