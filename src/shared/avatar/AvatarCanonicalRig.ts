...
const REST_POSITION_COMPONENTS: Record<AvatarSkeletonJointName, readonly [number, number, number]> = {
    ...
    rightFoot: [0, -0.46, 0],
    rightToes: [0, 0, 0.11],
    leftThumbMetacarpal: [0.02, -0.012, 0.03],
    leftThumbProximal: [0.024, 0, 0.016],
    leftThumbDistal: [0.02, 0, 0.01],
    leftThumbTip: [0.016, 0, 0.006],
    ...
    rightThumbMetacarpal: [-0.02, -0.012, 0.03],
    rightThumbProximal: [-0.024, 0, 0.016],
    rightThumbDistal: [-0.02, 0, 0.01],
    rightThumbTip: [-0.016, 0, 0.006],
